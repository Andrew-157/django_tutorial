...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() returns True for the question
...
def create_question(question_text, days):
    """
    Create question with the given 'question_text' and published given number of 'days'
    offset to now (negative for questions published in the past and positive for questions
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self):
        ...
        question_1 = create_question(
            question_text="First past question.", days=-30)
        question_2 = create_question(
            question_text="Second past question.", days=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'], [
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        The detail view of a question with pub date in the past
